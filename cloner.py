...
private_account = '''<span class="css-1qaijid r-bcqeeo r-qvutc0 r-poiln3 r-1pos5eu" style="text-overflow: unset;"><span class="css-1qaijid r-bcqeeo r-qvutc0 r-poiln3 r-adyw6z r-135wba7 r-xoduu5 r-18u37iz r-1q142lx" style="text-overflow: unset;"><span class="css-1qaijid r-bcqeeo r-qvutc0 r-poiln3 r-1awozwy r-xoduu5" style="text-overflow: unset;"><div class="css-175oi2r r-xoduu5"><div aria-label="Provides details about protected accounts." role="button" tabindex="0" class="css-175oi2r r-9cviqr r-6koalj r-1loqt21 r-o7ynqc r-6416eg r-1ny4l3l"><svg viewBox="0 0 24 24" aria-label="Protected account" role="img" class="r-4qtqp9 r-yyyyoo r-1xvli5t r-bnwqim r-1plcrui r-lrvibr r-9cviqr r-1nao33i r-f9ja8p r-og9te1" data-testid="icon-lock"><g><path d="M17.5 7H17v-.25c0-2.76-2.24-5-5-5s-5 2.24-5 5V7h-.5C5.12 7 4 8.12 4 9.5v9C4 19.88 5.12 21 6.5 21h11c1.39 0 2.5-1.12 2.5-2.5v-9C20 8.12 18.89 7 17.5 7zM13 14.73V17h-2v-2.27c-.59-.34-1-.99-1-1.73 0-1.1.9-2 2-2 1.11 0 2 .9 2 2 0 .74-.4 1.39-1 1.73zM15 7H9v-.25c0-1.66 1.35-3 3-3 1.66 0 3 1.34 3 3V7z"></path></g></svg></div></div></span></span></span>'''

def make_unread_items(unread_items):
    if unread_items != "":
        return f'''<div dir="ltr" aria-label="{unread_items} unread items" aria-live="polite" class="css-1rynq56 r-qvutc0 r-37j5jr r-1b43r93 r-1cwl3u0 r-b88u0q r-1awozwy r-l5o3uw r-sdzlij r-6koalj r-1q142lx r-1777fci r-lrvibr r-3s2u2q r-1xc7w19 r-1phboty r-rs99b7 r-1tjplnt r-z80fyv r-i61hcz r-19u6a5r" style="text-overflow: unset; color: rgb(255, 255, 255)" > <span class="css-1qaijid r-bcqeeo r-qvutc0 r-poiln3" style="text-overflow: unset" >{unread_items}</span > </div>'''
    else:
        return ""
...
class TwitterGUI:
    def __init__(self, root):
        ...
        self.checkmark_options = ttk.Combobox(root, values=["No checkmark", "Blue checkmark", "Yellow checkmark", "Private account"])
